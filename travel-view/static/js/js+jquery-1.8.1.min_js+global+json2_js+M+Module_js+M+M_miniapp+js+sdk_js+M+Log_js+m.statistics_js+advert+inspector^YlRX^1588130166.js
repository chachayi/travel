...
/**
 * Module���JavaScript������������������������������������CMD���������CommonJS���������
 *
 * ���������������������������������������������������uri���������������������������������������������
 * ������������������������Ecma5������(polyfill)���������indexOf, forEach, trim���
 * ������Dom���������jQuery���������������������web���������������������������������������������������������������������������
 *
...
is = function(obj, type) { // ���������������type������build in function and native functionss
...
var define = global.define = M.define = function(id, factory) { // factory can be object or array
    // params check
    if(!is(id, 'String')) { // ���������������������������id���������������������id������������������������������
        M.error('module id invalid:'+id);
    }

    if(!isFunction(factory) && !isObject(factory)) { // ���������������������������������������������������������������������������������������������������������������������������������������������dom���������
...
(function () {
    ...
    //������������IE9���document.getElementsByClassName������
    ...
    /**
     * ������������
     * 1.Chrome���FireFox���Opera���Safari���IE9.0������������������addEventListener
     * 2.IE8.0������������������attachEvent
     * 3.���������������on
     * @param oObj
     * @param sType
